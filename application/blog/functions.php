...
/*-----------------------------------------------------------------------------------*/
	...
	add_image_size( 'featured', 590, 200, true ); //featured
	add_image_size( 'related', 180, 120, true ); //related
	add_image_size( 'widgetthumb', 50, 50, true ); //widgetthumb
    add_image_size( 'widgetbigthumb', 300, 157, true);//widgetbigthumb
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	register_sidebar(array('name'=>'Header',
		'description' => __('This header area can be used for Search Form or 460x60 Ad.', 'example'),
...
function mytheme_comment($comment, $args, $depth) {
	...
	<div id="comment-<?php comment_ID(); ?>" style="position:relative;">
		...
		<div class="commentRight">
			...
			<?php $options = get_option('truepixel'); if($options['mts_comment_date'] == '1') { ?>
