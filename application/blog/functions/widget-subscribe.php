...
/*-----------------------------------------------------------------------------------*/
	...
	function mts_Subscribe_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mts_subscribe_widget', 'description' => __('Feedburner Subscription Widget.', 'framework') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'mts_subscribe_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'mts_subscribe_widget', __('MyThemeShop: Subscribe Widget', 'framework'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<div class="mts-subscribe">
				...
				<input type="hidden" value="<?php echo $desc; ?>" name="uri"><input type="hidden" name="loc" value="en_US"><input type="submit" value="Subscribe">
				</form>
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>"><?php _e('Feedburner id (http://feeds.feedburner.com/<b>mythemeshop</b>):', 'framework') ?></label>
