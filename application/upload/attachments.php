	...
	public static function swfupload(){
		if( isset( $_REQUEST['dosubmit']) ){
			if( isset( $_REQUEST['filename']) ){
				@error_log( "\ntype=".$_REQUEST['type'] , 3 , "/tmp/pzr.log" );
				@error_log( "\nfilename=".$_REQUEST['filename'] , 3 , "/tmp/pzr.log" ); //filetype_post
				@error_log( "\n filetype_post=".$_POST['filetype_post']."  Filedata=".$_POST['Filedata'] , 3 , "/tmp/pzr.log" );
				exit;
			}
		}
		session_id();
